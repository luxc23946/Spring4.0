...
public class Main{
	...
	@Before
	public void init(){
		ctx=new ClassPathXmlApplicationContext("hpe/lxc/spring/tx_xml/applicationContext-tx_xml.xml");
		bookShopDao=(BookShopDao) ctx.getBean("bookShopDao");
		BookShopService= (hpe.lxc.spring.tx_xml.BookShopService) ctx.getBean("bookShopService");
