package hpe.lxc.spring.beans.aop_aspectj;
...
public class LoggingAspect {
	 ...
	 */
	@Pointcut("execution(* hpe.lxc.spring.beans.aop_aspectj.ArithmeticCalculatorImpl.*(int, int))")
	 ...
	 * public int hpe.lxc.spring.beans.aop.aspectj.ArithmeticCalculatorImpl.add(int, int) 声明只作用与一个方法
	 * public int hpe.lxc.spring.beans.aop.aspectj.ArithmeticCalculatorImpl.a*(int, int) 声明只作用于匹配的方法
	 * public int hpe.lxc.spring.beans.aop.aspectj.ArithmeticCalculatorImpl.*(..)声明作用于该类的所有方法 任意参数
	 */
	@Before("execution(public int hpe.lxc.spring.beans.aop_aspectj.ArithmeticCalculatorImpl.*(int, int))")
	 ...
	 * 在返回通知中能访问目标方法执行的返回值
	 */
	@AfterReturning(value="hpe.lxc.spring.beans.aop_aspectj.LoggingAspect.declareJoinPonitExpression()",
			returning="result")
