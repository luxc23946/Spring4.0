...
public class Main{
	...
	@Before
	public void init(){
		ctx=new ClassPathXmlApplicationContext("hpe/lxc/spring/tx_one/applicationContext-tx_one.xml");
		bookShopDao=(BookShopDao) ctx.getBean("bookShopDao");
		BookShopService= (hpe.lxc.spring.tx_one.BookShopService) ctx.getBean("bookShopService");
